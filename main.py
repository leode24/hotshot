...
# set movement boundaries
  ...
  if CDS == True:  
    ...
    if terrain_mask.overlap(cargo_mask,(cargo_x + x_pos + 228 - screen_scroll, cargo_y + y_pos)) or terrain_mask.overlap(cargo_mask,(cargo_x + x_pos + 228 - screen_scroll + 4608, cargo_y + y_pos)):
      CDS = False
